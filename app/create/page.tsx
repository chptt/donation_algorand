                ...
                {charityTypes.map((type, i) => {
                  ...
                  return (
                    <motion.button key={i} type="button" whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}
                      ...
                      className={`p-4 rounded-lg border-2 transition-all ${form.charityType === i ? 'border-primary-500 bg-primary-950' : 'border-gray-700 hover:border-gray-600 bg-gray-800'}`}>
