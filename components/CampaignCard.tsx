    ...
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} whileHover={{ y: -5 }}
      ...
      <div className="p-6">
        ...
        <div className="mb-4">
          <div className="flex justify-between items-center mb-2">
            ...
            <span className="text-sm font-medium text-gray-900">
              {raised.toFixed(2)} / {goal.toFixed(2)} ALGO
            </span>
          </div>
        ...
        <div className="flex justify-between items-center text-sm text-gray-600 mb-4">
          ...
          <span className={`px-2 py-1 rounded-full text-xs ${campaign.active ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'}`}>
